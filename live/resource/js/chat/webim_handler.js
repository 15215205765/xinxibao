...
function convertGroupTipMsgToHtml(o) {
    ...
    switch (e = o.getOpType(), i = o.getOpUserId(), e) {
      ...
      case webim.GROUP_TIP_TYPE.MODIFY_GROUP_INFO:
        r += i + "修改了群资料：";
        var c, u, g = o.getGroupInfoList();
        for (var s in g) switch (c = g[s].getType(), u = g[s].getValue(), c) {
...
function onSendMsg(o, e) {
    if (loginInfo.identifier) if (selToID) {
        ...
        n = "消息长度超出限制(最多" + Math.round(i / 3) + "汉字)", i < r) console.error(n); else {
            ...
            var g = new webim.Msg(selSess, !0, -1, c, u, loginInfo.identifier, s, loginInfo.identifierNick);
            loginInfo.identifierNick;
            /进入房间/gi.test(t) && (g.content_type = 99, "系统消息");
            var a = {
                ...
                random: o.random
            }, m = new webim.Msg.Elem.Custom(t, "", JSON.stringify(a));
            g.addCustom(m), webim.sendMsg(g, function(o) {
                selType == webim.SESSION_TYPE.C2C && showMsg(g), webim.Log.info("发消息成功"), e && e();
            }, function(o) {
