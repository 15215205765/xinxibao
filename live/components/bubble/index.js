...
Component({
    ...
    attached: function() {},
    ready: function() {
        console.log(444444, this.data.live_id), console.log(444444, this.data.giveups), 
    ...
    methods: {
        ...
        clear: function() {
            console.log(333333), clearTimeout(this.timer), clearTimeout(this.autoBubbleTimer), 
            this.timer = null, this.ctx && this.ctx.draw(), this.setData({
                show: !1
            });
        },
        showBubble: function() {
            this.ctx || (this.init(), this.downloadAllImageArr()), console.log(111111, this.data.images);
        ...
        downloadImageArr: function(e) {
            ...
            this.downloadFile(t).then(function(t) {
                i.data.images[e] = t, console.log(33333, i.data.images[e]);
            });
        },
        ...
        animate: function() {
            var t = this, o = Date.now(), s = this.ctx, e = this.queue, l = this;
            this.queue = e.filter(function(t) {
                var e = l.getAnimalA(t), i = l.getAnimalI(t), a = i.x, n = i.y;
                return s.globalAlpha = l.getAnimalR(t), s.drawImage(t.icon, a, n, e, e), t.t = (o - t.start) / 2e3, 
                t.t < 1;
        ...
        getAnimalI: function(t) {
            var e = t.bezier, i = e[0], a = e[1], n = e[2], o = e[3], s = t.t, l = 3 * (a.x - i.x), r = 3 * (n.x - a.x) - l, h = o.x - i.x - l - r, u = 3 * (a.y - i.y), m = 3 * (n.y - a.y) - u, d = o.y - i.y - u - m;
            return {
                x: h * (s * s * s) + r * (s * s) + l * s + i.x,
