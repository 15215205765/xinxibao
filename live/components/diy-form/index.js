...
Component({
    ...
    methods: {
        ...
        timeTransform: function(t, a) {
            var e = "", i = new Date(t), n = i.getFullYear() + "-", r = (i.getMonth() + 1 < 10 ? "0" + (i.getMonth() + 1) : i.getMonth() + 1) + "-", s = (i.getDate() < 10 ? "0" + i.getDate() : i.getDate()) + " ", d = (i.getHours() < 10 ? "0" + i.getHours() : i.getHours()) + ":", u = (i.getMinutes() < 10 ? "0" + i.getMinutes() : i.getMinutes()) + ":", h = i.getSeconds() < 10 ? "0" + i.getSeconds() : i.getSeconds();
            return 1 == a ? e = n + r + s + d + u + h : 2 == a ? e = n + r + s : 3 == a && (e = d + u + h), 
            e;
        },
        afterRead: function(d) {
            var u = this, h = d.detail.file;
            wx.uploadFile({
                ...
                success: function(t) {
                    ...
                    s.push({
                        url: a.data.url
                    }), r[n].value = s, r[n].err_msg = u.inputErrMsg(r[n]), u.setData({
                        value: r,
                        fileList: i
                    }), u.doSetFormData();
                }
        ...
        onDeleteImg: function(t) {
            for (var a = this.data.fileList, e = t.currentTarget.dataset.index, i = this.data.value, n = i[e].value, r = 0; r < a.length; r++) r == t.detail.index && (a.splice(r, 1), 
            n.splice(r, 1));
            i[e].value = n, this.setData({
                fileList: a,
                value: i
            }), this.doSetFormData();
        },
