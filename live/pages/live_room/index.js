var _Page, _wxParse = require("../../lib/wxParse/wxParse"), _wxParse2 = _interopRequireDefault(_wxParse), _order = require("../../../api/order.js"), _util = require("../../lib/utils/util.js"), _util2 = _interopRequireDefault(_util), _live = require("../../../api/live"), _live2 = require("../../../api/plugin/viewing_rewards/live"), _goods = require("../../../api/goods");
...
Page((_defineProperty(_Page = {
  ...
  var e = this;
  wx.previewImage({
    current: e.data.posterImage, //当前图片地址
    urls: [e.data.posterImage], //一张图写法
