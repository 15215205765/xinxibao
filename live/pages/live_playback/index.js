var _data, _Page, _wxParse = require("../../lib/wxParse/wxParse"), _wxParse2 = _interopRequireDefault(_wxParse), _order = require("../../../api/order.js"), _util = require("../../../lib/utils/util.js"), _util2 = _interopRequireDefault(_util), _live = require("../../../api/live"), _goods = require("../../../api/goods");
...
Page((_defineProperty(_Page = {
    data: (_data = {
        ...
        storeImage: "",
        inputValue: ""
    }, _defineProperty(_data, "comments", []), _defineProperty(_data, "actions", [ {
        type: "share",
        name: "分享给好友",
        openType: "share"
    }, {
...
_defineProperty(_Page, "onPullDownRefresh", function() {}), _defineProperty(_Page, "queryMultipleNodes", function() {
    ...
    var a = this;
    console.log(111111, this.data.live), (0, _live.getLiveQrcode)(this.data.live.live_id).then(function(t) {
        wx.downloadFile({
            url: t.data.code,
            success: function(t) {
