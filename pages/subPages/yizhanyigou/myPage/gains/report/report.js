...
Page({
	...
	onLoad: function(options) {
		...
		// })
		this.setData({
			information: wx.getStorageSync('personal')
		})
	...
	getGainsDetails() {
		let _self = this
		app.http.get(
			`${app.globalData.phpUrl}/app/app.php?i=2&c=entry&m=ewei_shopv2&do=mobile&r=member.taobaoke.profit_stat`, {
